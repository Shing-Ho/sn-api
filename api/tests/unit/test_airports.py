...
class TestAirports(TestCase):
    def test_find_by_prefix(self):
        test_models.create_airport(airport_id=1, airport_code="FOO", airport_name="Foocity Intl")
        test_models.create_airport(airport_id=2, airport_code="BAR", airport_name="Barland Commuter")
        test_models.create_airport(airport_id=3, airport_code="BAZ", airport_name="Baztown International")
        test_models.create_airport(airport_id=4, airport_code="BAX", airport_name="Baxville Airport")
        test_models.create_airport(airport_id=5, airport_code="FOC", airport_name="Foo Town Commuter")
